<template><div><h1 id="cs61a-hw-6" tabindex="-1"><a class="header-anchor" href="#cs61a-hw-6" aria-hidden="true">#</a> CS61a HW 6</h1>
<h1 id="scheme" tabindex="-1"><a class="header-anchor" href="#scheme" aria-hidden="true">#</a> Scheme</h1>
<p>Link to this section: <a href="https://inst.eecs.berkeley.edu/~cs61a/fa20/hw/hw06/" target="_blank" rel="noopener noreferrer">https://inst.eecs.berkeley.edu/~cs61a/fa20/hw/hw06/<ExternalLinkIcon/></a></p>
