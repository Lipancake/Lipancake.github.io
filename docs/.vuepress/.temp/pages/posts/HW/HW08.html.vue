<template><div><h1 id="cs61a-hw-8" tabindex="-1"><a class="header-anchor" href="#cs61a-hw-8" aria-hidden="true">#</a> CS61a HW 8</h1>
<h1 id="more-scheme" tabindex="-1"><a class="header-anchor" href="#more-scheme" aria-hidden="true">#</a> More Scheme</h1>
<p>Link to this section: <a href="https://inst.eecs.berkeley.edu/~cs61a/fa20/hw/hw08/" target="_blank" rel="noopener noreferrer">https://inst.eecs.berkeley.edu/~cs61a/fa20/hw/hw08/<ExternalLinkIcon/></a></p>
