<template><div><h1 id="cs61a-hw-5" tabindex="-1"><a class="header-anchor" href="#cs61a-hw-5" aria-hidden="true">#</a> CS61a HW 5</h1>
<h1 id="object-oriented-programming-linked-lists-trees" tabindex="-1"><a class="header-anchor" href="#object-oriented-programming-linked-lists-trees" aria-hidden="true">#</a> Object-Oriented Programming, Linked Lists, Trees</h1>
<p>Link to this section: <a href="https://inst.eecs.berkeley.edu/~cs61a/fa20/hw/hw05/" target="_blank" rel="noopener noreferrer">https://inst.eecs.berkeley.edu/~cs61a/fa20/hw/hw05/<ExternalLinkIcon/></a></p>
