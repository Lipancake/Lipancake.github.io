<template><div><h1 id="cs61a-hw-4" tabindex="-1"><a class="header-anchor" href="#cs61a-hw-4" aria-hidden="true">#</a> CS61a HW 4</h1>
<h1 id="nonlocal-iterators" tabindex="-1"><a class="header-anchor" href="#nonlocal-iterators" aria-hidden="true">#</a> Nonlocal, Iterators</h1>
<p>Link to this section: <a href="https://inst.eecs.berkeley.edu/~cs61a/fa20/hw/hw04/" target="_blank" rel="noopener noreferrer">https://inst.eecs.berkeley.edu/~cs61a/fa20/hw/hw04/<ExternalLinkIcon/></a></p>
