<template><div><h1 id="cs61a-hw-7" tabindex="-1"><a class="header-anchor" href="#cs61a-hw-7" aria-hidden="true">#</a> CS61a HW 7</h1>
<h1 id="scheme-lists" tabindex="-1"><a class="header-anchor" href="#scheme-lists" aria-hidden="true">#</a> Scheme Lists</h1>
<p>Link to this section: <a href="https://inst.eecs.berkeley.edu/~cs61a/fa20/hw/hw07/" target="_blank" rel="noopener noreferrer">https://inst.eecs.berkeley.edu/~cs61a/fa20/hw/hw07/<ExternalLinkIcon/></a></p>
