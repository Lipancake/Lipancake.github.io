<template><div><h1 id="cs61a-hw-3" tabindex="-1"><a class="header-anchor" href="#cs61a-hw-3" aria-hidden="true">#</a> CS61a HW 3</h1>
<h1 id="trees-data-abstraction" tabindex="-1"><a class="header-anchor" href="#trees-data-abstraction" aria-hidden="true">#</a> Trees, Data Abstraction</h1>
<p>Link to this section: <a href="https://inst.eecs.berkeley.edu/~cs61a/fa20/hw/hw03/" target="_blank" rel="noopener noreferrer">https://inst.eecs.berkeley.edu/~cs61a/fa20/hw/hw03/<ExternalLinkIcon/></a></p>
