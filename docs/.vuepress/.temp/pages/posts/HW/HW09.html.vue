<template><div><h1 id="cs61a-hw-9" tabindex="-1"><a class="header-anchor" href="#cs61a-hw-9" aria-hidden="true">#</a> CS61a HW 9</h1>
<h1 id="sql" tabindex="-1"><a class="header-anchor" href="#sql" aria-hidden="true">#</a> SQL</h1>
<p>Link to this section: <a href="https://inst.eecs.berkeley.edu/~cs61a/fa20/hw/hw09/" target="_blank" rel="noopener noreferrer">https://inst.eecs.berkeley.edu/~cs61a/fa20/hw/hw09/<ExternalLinkIcon/></a></p>
