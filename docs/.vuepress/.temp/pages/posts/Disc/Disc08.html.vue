<template><div><h1 id="cs61a-disc-8" tabindex="-1"><a class="header-anchor" href="#cs61a-disc-8" aria-hidden="true">#</a> CS61a DISC 8</h1>
<h1 id="linked-lists-trees" tabindex="-1"><a class="header-anchor" href="#linked-lists-trees" aria-hidden="true">#</a> Linked Lists, Trees</h1>
<p>Link to this section: <a href="https://inst.eecs.berkeley.edu/~cs61a/fa21/disc/disc08/" target="_blank" rel="noopener noreferrer">https://inst.eecs.berkeley.edu/~cs61a/fa21/disc/disc08/<ExternalLinkIcon/></a></p>
