<template><div><h1 id="cs61a-disc-12" tabindex="-1"><a class="header-anchor" href="#cs61a-disc-12" aria-hidden="true">#</a> CS61a DISC 12</h1>
<h1 id="regular-expressions-bnf-sql" tabindex="-1"><a class="header-anchor" href="#regular-expressions-bnf-sql" aria-hidden="true">#</a> Regular Expressions, BNF, SQL</h1>
<p>Link to this section: <a href="https://inst.eecs.berkeley.edu/~cs61a/fa21/disc/disc12/" target="_blank" rel="noopener noreferrer">https://inst.eecs.berkeley.edu/~cs61a/fa21/disc/disc12/<ExternalLinkIcon/></a></p>
