<template><div><h1 id="cs61a-disc-6" tabindex="-1"><a class="header-anchor" href="#cs61a-disc-6" aria-hidden="true">#</a> CS61a DISC 6</h1>
<h1 id="mutability-iterators-and-generators" tabindex="-1"><a class="header-anchor" href="#mutability-iterators-and-generators" aria-hidden="true">#</a> Mutability, Iterators and Generators</h1>
<p>Link to this section: <a href="https://inst.eecs.berkeley.edu/~cs61a/fa21/disc/disc06/" target="_blank" rel="noopener noreferrer">https://inst.eecs.berkeley.edu/~cs61a/fa21/disc/disc06/<ExternalLinkIcon/></a></p>
