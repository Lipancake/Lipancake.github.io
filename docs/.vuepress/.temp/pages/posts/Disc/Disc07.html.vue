<template><div><h1 id="cs61a-disc-7" tabindex="-1"><a class="header-anchor" href="#cs61a-disc-7" aria-hidden="true">#</a> CS61a DISC 7</h1>
<h1 id="object-oriented-programming-string-representation" tabindex="-1"><a class="header-anchor" href="#object-oriented-programming-string-representation" aria-hidden="true">#</a> Object-Oriented Programming, String Representation</h1>
<p>Link to this section: <a href="https://inst.eecs.berkeley.edu/~cs61a/fa21/disc/disc07/" target="_blank" rel="noopener noreferrer">https://inst.eecs.berkeley.edu/~cs61a/fa21/disc/disc07/<ExternalLinkIcon/></a></p>
