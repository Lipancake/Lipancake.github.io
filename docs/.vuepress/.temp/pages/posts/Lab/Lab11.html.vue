<template><div><h1 id="cs61a-lab-11" tabindex="-1"><a class="header-anchor" href="#cs61a-lab-11" aria-hidden="true">#</a> CS61a Lab 11</h1>
<h1 id="interpreters" tabindex="-1"><a class="header-anchor" href="#interpreters" aria-hidden="true">#</a> Interpreters</h1>
<p>Link to this section: <a href="https://inst.eecs.berkeley.edu/~cs61a/fa20/lab/lab11/" target="_blank" rel="noopener noreferrer">https://inst.eecs.berkeley.edu/~cs61a/fa20/lab/lab11/<ExternalLinkIcon/></a></p>
