<template><div><h1 id="cs61a-lab-6" tabindex="-1"><a class="header-anchor" href="#cs61a-lab-6" aria-hidden="true">#</a> CS61a Lab 6</h1>
<h1 id="nonlocal-mutability" tabindex="-1"><a class="header-anchor" href="#nonlocal-mutability" aria-hidden="true">#</a> Nonlocal, Mutability</h1>
<p>Link to this section: <a href="https://inst.eecs.berkeley.edu/~cs61a/fa20/lab/lab06/" target="_blank" rel="noopener noreferrer">https://inst.eecs.berkeley.edu/~cs61a/fa20/lab/lab06/<ExternalLinkIcon/></a></p>
