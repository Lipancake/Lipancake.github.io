<template><div><h1 id="cs61a-lab-10" tabindex="-1"><a class="header-anchor" href="#cs61a-lab-10" aria-hidden="true">#</a> CS61a Lab 10</h1>
<h1 id="scheme" tabindex="-1"><a class="header-anchor" href="#scheme" aria-hidden="true">#</a> Scheme</h1>
<p>Link to this section: <a href="https://inst.eecs.berkeley.edu/~cs61a/fa20/lab/lab10/" target="_blank" rel="noopener noreferrer">https://inst.eecs.berkeley.edu/~cs61a/fa20/lab/lab10/<ExternalLinkIcon/></a></p>
