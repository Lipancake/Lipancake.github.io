<template><div><h1 id="cs61a-lab-12" tabindex="-1"><a class="header-anchor" href="#cs61a-lab-12" aria-hidden="true">#</a> CS61a Lab 12</h1>
<h1 id="sql" tabindex="-1"><a class="header-anchor" href="#sql" aria-hidden="true">#</a> SQL</h1>
<p>Link to this section: <a href="https://inst.eecs.berkeley.edu/~cs61a/fa20/lab/lab12/" target="_blank" rel="noopener noreferrer">https://inst.eecs.berkeley.edu/~cs61a/fa20/lab/lab12/<ExternalLinkIcon/></a></p>
