<template><div><h1 id="cs61a-project-4" tabindex="-1"><a class="header-anchor" href="#cs61a-project-4" aria-hidden="true">#</a> CS61a Project 4</h1>
<h1 id="scheme-interpreter" tabindex="-1"><a class="header-anchor" href="#scheme-interpreter" aria-hidden="true">#</a> Scheme Interpreter</h1>
<p>Link to this section: <a href="https://inst.eecs.berkeley.edu/~cs61a/fa20/proj/scheme/" target="_blank" rel="noopener noreferrer">https://inst.eecs.berkeley.edu/~cs61a/fa20/proj/scheme/<ExternalLinkIcon/></a></p>
