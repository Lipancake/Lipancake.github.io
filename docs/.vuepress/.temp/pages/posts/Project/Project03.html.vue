<template><div><h1 id="cs61a-project-3" tabindex="-1"><a class="header-anchor" href="#cs61a-project-3" aria-hidden="true">#</a> CS61a Project 3</h1>
<h1 id="ants-vs-somebees" tabindex="-1"><a class="header-anchor" href="#ants-vs-somebees" aria-hidden="true">#</a> Ants Vs. SomeBees</h1>
<p>Link to this section: <a href="https://inst.eecs.berkeley.edu/~cs61a/fa20/proj/ants/" target="_blank" rel="noopener noreferrer">https://inst.eecs.berkeley.edu/~cs61a/fa20/proj/ants/<ExternalLinkIcon/></a></p>
