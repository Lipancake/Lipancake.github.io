<template><div><h1 id="cs61a-project-1" tabindex="-1"><a class="header-anchor" href="#cs61a-project-1" aria-hidden="true">#</a> CS61a Project 1</h1>
<h1 id="the-game-of-hog" tabindex="-1"><a class="header-anchor" href="#the-game-of-hog" aria-hidden="true">#</a> The Game of Hog</h1>
<p>Link to this section: <a href="https://inst.eecs.berkeley.edu/~cs61a/fa20/proj/hog/" target="_blank" rel="noopener noreferrer">https://inst.eecs.berkeley.edu/~cs61a/fa20/proj/hog/<ExternalLinkIcon/></a></p>
